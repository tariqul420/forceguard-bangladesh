  ...
  return (
    <div className="mt-6 p-6 bg-white rounded-lg shadow-md">
      ...
      <div className="mt-6 flex justify-center">
        <Link href={'/police/all-police-station'} className="data-page-btn inline-block px-6 py-2 bg-green-700 text-white rounded-md hover:bg-green-800 transition-all duration-300">

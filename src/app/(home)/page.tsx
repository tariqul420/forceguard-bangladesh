...
export default function Home() {
  return (
    <div className="flex flex-col items-center gap-6 p-6 md:flex-row md:justify-center">
      <Link href={'/army'} className="bg-dark shadow-lg rounded-2xl p-4 w-80 text-center">
      ...
      <Link href={'/police'} className="bg-dark shadow-lg rounded-2xl p-4 w-80 text-center">
